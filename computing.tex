...
To set the scale, let's consider an approximate theoretical \textbf{upper limit} on the number of channels above the threshold
...
% From the two channel count numbers quoted above, we assume the smaller number of channels for the purposes of this discussion.
...
%We present quantitative estimates in~\ref{bin_table}.
