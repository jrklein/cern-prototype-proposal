...
\subsubsection{Event Size Estimates}
...
In most cases the data will be zero-suppressed at the source. The data reduction factor will depend on a variety of parameters, but as a rule of thumb
